...
def catboost_transform(images, base_file_name, x_min, y_min, mask, field_name, x, y, label, size, resolution=RESOLUTION):
    cropped_images = {
        name: crop_or_pad(image, (x - x_min) // resolution, (y_max - y) // resolution, size)
